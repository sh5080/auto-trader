...
func (*User) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case user.FieldName, user.FieldNickname, user.FieldEmail, user.FieldPassword:
...
func (_m *User) QueryStrategies() *StrategyQuery {
	return NewUserClient(_m.config).QueryStrategies(_m)
}

// QueryPortfolios queries the "portfolios" edge of the User entity.
func (_m *User) QueryPortfolios() *PortfolioQuery {
	return NewUserClient(_m.config).QueryPortfolios(_m)
}
