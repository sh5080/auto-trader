...
func IsValid(v bool) predicate.User {
	return predicate.User(sql.FieldEQ(FieldIsValid, v))
}
...
func IsValidEQ(v bool) predicate.User {
	return predicate.User(sql.FieldEQ(FieldIsValid, v))
}

// IsValidNEQ applies the NEQ predicate on the "is_valid" field.
func IsValidNEQ(v bool) predicate.User {
	return predicate.User(sql.FieldNEQ(FieldIsValid, v))
}
