...
type StrategyQuery struct {
	...
	withUser        *UserQuery
	withTemplate    *StrategyTemplateQuery
	withExecutions  *StrategyExecutionQuery
	withPerformance *StrategyPerformanceQuery
	withStatus      *StrategyStatusQuery
...
func (_q *StrategyQuery) QueryUser() *UserQuery {
...
func (_q *StrategyQuery) QueryTemplate() *StrategyTemplateQuery {
	query := (&StrategyTemplateClient{config: _q.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := _q.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
func (_q *StrategyQuery) QueryExecutions() *StrategyExecutionQuery {
	query := (&StrategyExecutionClient{config: _q.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := _q.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
// QueryPerformance chains the current query on the "performance" edge.
func (_q *StrategyQuery) QueryPerformance() *StrategyPerformanceQuery {
	query := (&StrategyPerformanceClient{config: _q.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := _q.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
func (_q *StrategyQuery) QueryStatus() *StrategyStatusQuery {
	query := (&StrategyStatusClient{config: _q.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := _q.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
func (_q *StrategyQuery) Clone() *StrategyQuery {
	...
	return &StrategyQuery{
		...
		withPerformance: _q.withPerformance.Clone(),
...
func (_q *StrategyQuery) WithUser(opts ...func(*UserQuery)) *StrategyQuery {
	query := (&UserClient{config: _q.config}).Query()
...
func (_q *StrategyQuery) WithTemplate(opts ...func(*StrategyTemplateQuery)) *StrategyQuery {
	query := (&StrategyTemplateClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *StrategyQuery) WithExecutions(opts ...func(*StrategyExecutionQuery)) *StrategyQuery {
	query := (&StrategyExecutionClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
// WithPerformance tells the query-builder to eager-load the nodes that are connected to
// the "performance" edge. The optional arguments are used to configure the query builder of the edge.
func (_q *StrategyQuery) WithPerformance(opts ...func(*StrategyPerformanceQuery)) *StrategyQuery {
	query := (&StrategyPerformanceClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	_q.withPerformance = query
	return _q
}
...
func (_q *StrategyQuery) WithStatus(opts ...func(*StrategyStatusQuery)) *StrategyQuery {
	query := (&StrategyStatusClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *StrategyQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Strategy, error) {
	...
	if query := _q.withUser; query != nil {
		if err := _q.loadUser(ctx, query, nodes, nil,
			func(n *Strategy, e *User) { n.Edges.User = e }); err != nil {
			return nil, err
		}
	}
	if query := _q.withTemplate; query != nil {
		if err := _q.loadTemplate(ctx, query, nodes, nil,
			func(n *Strategy, e *StrategyTemplate) { n.Edges.Template = e }); err != nil {
			return nil, err
		}
	}
	if query := _q.withExecutions; query != nil {
		if err := _q.loadExecutions(ctx, query, nodes,
			func(n *Strategy) { n.Edges.Executions = []*StrategyExecution{} },
			func(n *Strategy, e *StrategyExecution) { n.Edges.Executions = append(n.Edges.Executions, e) }); err != nil {
			return nil, err
		}
	}
	if query := _q.withPerformance; query != nil {
		if err := _q.loadPerformance(ctx, query, nodes, nil,
			func(n *Strategy, e *StrategyPerformance) { n.Edges.Performance = e }); err != nil {
			return nil, err
		}
	}
	if query := _q.withStatus; query != nil {
		if err := _q.loadStatus(ctx, query, nodes, nil,
			func(n *Strategy, e *StrategyStatus) { n.Edges.Status = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *StrategyQuery) loadUser(ctx context.Context, query *UserQuery, nodes []*Strategy, init func(*Strategy), assign func(*Strategy, *User)) error {
...
func (_q *StrategyQuery) loadTemplate(ctx context.Context, query *StrategyTemplateQuery, nodes []*Strategy, init func(*Strategy), assign func(*Strategy, *StrategyTemplate)) error {
	ids := make([]uuid.UUID, 0, len(nodes))
	nodeids := make(map[uuid.UUID][]*Strategy)
	for i := range nodes {
	...
	query.Where(strategytemplate.IDIn(ids...))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
	}
...
func (_q *StrategyQuery) loadExecutions(ctx context.Context, query *StrategyExecutionQuery, nodes []*Strategy, init func(*Strategy), assign func(*Strategy, *StrategyExecution)) error {
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(strategyexecution.FieldStrategyID)
	}
	query.Where(predicate.StrategyExecution(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(strategy.ExecutionsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *StrategyQuery) loadPerformance(ctx context.Context, query *StrategyPerformanceQuery, nodes []*Strategy, init func(*Strategy), assign func(*Strategy, *StrategyPerformance)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[uuid.UUID]*Strategy)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(strategyperformance.FieldStrategyID)
	}
	query.Where(predicate.StrategyPerformance(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(strategy.PerformanceColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *StrategyQuery) loadStatus(ctx context.Context, query *StrategyStatusQuery, nodes []*Strategy, init func(*Strategy), assign func(*Strategy, *StrategyStatus)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[uuid.UUID]*Strategy)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(strategystatus.FieldStrategyID)
	}
	query.Where(predicate.StrategyStatus(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(strategy.StatusColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *StrategyQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withUser != nil {
			_spec.Node.AddColumnOnce(strategy.FieldUserID)
		}
		if _q.withTemplate != nil {
			_spec.Node.AddColumnOnce(strategy.FieldTemplateID)
		}
	}
